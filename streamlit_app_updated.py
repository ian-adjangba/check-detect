...
country = st.sidebar.selectbox(
    ...
    COUNTRY_OPTIONS,
    help="Start typing to search country options.",
)

branch_selection = st.sidebar.selectbox(
    "Branch inquiry",
    BRANCH_DIRECTORY[country],
    help="Start typing to search branch location and call number options for the selected country.",
)
...
with tab1:
    ...
    if st.button("Run Check Detect Review", use_container_width=True):
        ...
        st.info(
            ...
            f"Branch Inquiry: {branch_selection}"
        )
...
with tab3:
    ...
    st.write(
        "The interface is designed for non-technical bank tellers. It uses a guided sidebar, searchable dropdowns, "
